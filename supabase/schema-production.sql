-- QIC Life Track 1 Production Schema - AI + Gamification Focus
-- Comprehensive production-grade database schema supporting the AI-powered engagement loop:
...
-- Missions table - Enhanced with gamification fields (FIXED TYPO: BOOAN → BOOLEAN)
CREATE TABLE missions (
    ...
    is_active BOOLEAN DEFAULT TRUE, -- FIXED TYPO
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- ============================================================================
-- PHASE 6.2: MATERIALIZED VIEWS FOR ANALYTICS
-- ============================================================================
...
-- ============================================================================
-- SAMPLE DATA FOR MVP (Phase 9)
-- ============================================================================

-- Sample Missions (5 per category = 25 total)
...
-- Sample Data: 25 missions, 10 rewards, 10 achievements
